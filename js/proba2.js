...
//If after going through all the numbers between 2 and one less than the number and none of them
// were evenly divided (no remainder) not_prime will still be false and the console will print the number.
    if (prime === false) {
      console.log(counter);
    }
  }
